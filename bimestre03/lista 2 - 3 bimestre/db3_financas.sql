...
/*1)Escreva uma consulta que liste todas as transações junto com o nome da conta associada a cada transação. Utilize 
INNER JOIN para combinar as tabelas de transações e contas.
*/

SELECT transacoes.*, contas.nome FROM transacoes INNER JOIN contas
ON transacoes.conta_id = contas.conta_id;

/*2) Escreva uma consulta que liste todas as transações junto com o nome da
